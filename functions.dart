...
exo1_1()
{
  ...
  for (var i=1; i<=10; i++)
    ...
    print("l'intéret pour la ${i}iem année est ${interet_annuel}");
...
exo1_7(List maliste)
  ...
  print("la liste de mots ayant moins de 6 caracteres :${listmotmoin_desixcar}");
  print("la liste de mots ayant 6 caracteres ou plus :${listmotplus_desixcar}");
...
exo1_9()
 ...
 List prenom = ['Jean-Michel', 'Marc', 'Vanessa', 'Anne', 'Maximilien', 'Alexandre-Benoît', 'Louise'];
  for ( var i=0; i<prenom.length; i++)
    {
    print("\n${prenom[i]} ==> ${prenom[i].length} caractères");
    }
